...
GO
/****** Object:  Trigger [dbo].[TR_Booking_Audit]    Script Date: 2021/05/20 12:04:54 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT @sql = '
INSERT CustomerAudit (Type, TableName, PKColumnName, PK, FieldName, OldValue, NewValue, CreatedOn, CreatedByUserID)
