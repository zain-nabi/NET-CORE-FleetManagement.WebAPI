...
DECLARE @LookupcodeCategoryID VARCHAR(100) = (SELECT LC.LookupcodeCategoryID  FROM [dbo].[LookupcodeCategories] LC WITH(NOLOCK) WHERE LC.Category = 'Bookings Reasons')
DECLARE @Item1 VARCHAR(100) ='Service'
DECLARE @Item2 VARCHAR(100) ='Quotation'
