...
DECLARE @LookupcodeCategoryID VARCHAR(100) = (SELECT LC.LookupcodeCategoryID  FROM [dbo].[LookupcodeCategories] LC WITH(NOLOCK) WHERE LC.Category = 'MileAge Or Hour')
DECLARE @Item1 VARCHAR(100) ='MileAge'
DECLARE @Item2 VARCHAR(100) ='Hour'
