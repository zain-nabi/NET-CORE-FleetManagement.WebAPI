...
GO
CREATE TRIGGER [dbo].[TR_Booking_Audit] ON [dbo].[Bookings] FOR INSERT, UPDATE, DELETE
AS
...
SELECT @sql = '
INSERT BookingAudit (Type, TableName, PKColumnName, PK, FieldName, OldValue, NewValue, CreatedOn, CreatedByUserID)
