...
BEGIN TRY
  ...
  DECLARE @CompanyIDTTM INT
    ...
    INSERT INTO [dbo].[VendorCode]([CustomerID],[CompanyID],[VendorCodes])
      ...
      (@CustomerID,@CompanyIDTTM,@VendorCodeTTM)
  END
  ELSE IF(@VendorCodeTFM IS NOT NULL) 
    BEGIN
       INSERT INTO [dbo].[VendorCode]([CustomerID],[CompanyID],[VendorCodes])
       VALUES
	   (@CustomerID,@CompanyID,@VendorCodeTFM )
    END

  ELSE IF(@VendorCodeTTM IS NOT NULL) 
    BEGIN
       INSERT INTO [dbo].[VendorCode]([CustomerID],[CompanyID],[VendorCodes])
       VALUES
	   (@CustomerID,@CompanyID,@VendorCodeTTM )
    END
