...
DECLARE @LookupcodeCategoryID VARCHAR(100) = (SELECT LC.LookupcodeCategoryID  FROM [dbo].[LookupcodeCategories] LC WITH(NOLOCK) WHERE LC.Category = 'Quotations')
DECLARE @Item1 VARCHAR(100) ='Booking'
DECLARE @Item2 VARCHAR(100) ='Invoice'
