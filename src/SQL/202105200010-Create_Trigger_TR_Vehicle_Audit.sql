...
GO
CREATE TRIGGER [dbo].[TR_Vehicle_Audit] ON [dbo].[Vehicle] FOR INSERT, UPDATE, DELETE
AS
...
SELECT @sql = '
INSERT VehicleAudit (Type, TableName, PKColumnName, PK, FieldName, OldValue, NewValue, CreatedOn, CreatedByUserID)
