...
DECLARE @LookupcodeCategoryID VARCHAR(100) = (SELECT LC.LookupcodeCategoryID  FROM [dbo].[LookupcodeCategories] LC WITH(NOLOCK) WHERE LC.Category = 'Contact Details')
DECLARE @Item1 VARCHAR(100) ='Management'
DECLARE @Item2 VARCHAR(100) ='Operations'
DECLARE @Item3 VARCHAR(100) ='Accounts'
