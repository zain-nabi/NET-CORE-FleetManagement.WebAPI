...
CREATE PROCEDURE  proc_Customer_Insert_CustomerModel
(
	/*Customer Parameters*/
    @Name                     VARCHAR(255),
...
BEGIN TRY
	...
	INSERT INTO [dbo].[Customer]
           ([Name],[AccountNumber],[VatRegistration],[TelephoneNumber],[CellphoneNumber],[Email],[CreditLimit],[LoyaltySpend],[LoyaltyStatusLCID]
           ...
           ,[PostalSuburb],[PostalCode],[CreatedOn],[CreatedByUserID] ,[DeletedOn],[DeletedByUserID],[CompanyID])
     VALUES
           (@Name,@AccountNumber ,@VatRegistration,@TelephoneNumber,@CellphoneNumber,@Email,@CreditLimit,@LoyaltySpend,@LoyaltyStatusLCID
           ...
           ,@PostalSuburb,@PostalCode,GETDATE(),@CreatedByUserID,NULL,NULL,@CompanyID)
